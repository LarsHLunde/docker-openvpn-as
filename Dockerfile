...
RUN echo "deb [arch=$(dpkg --print-architecture) signed-by=/etc/apt/keyrings/as-repository.asc] http://packages.openvpn.net/as/debian bookworm main">/etc/apt/sources.list.d/openvpn-as-repo.list
RUN apt-get update
